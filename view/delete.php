...
<form action="" method="POST" class="flex justify-center">
    <div class="bg-orange-300 p-10 m-10 rounded-md ">
        ...
        <a href="../index.php" type="submit" class="bg-red-600  text-white font-sans font-bold mt-4 w-20 h-10 rounded-md flex justify-center items-center hover:bg-red-700">Yes</a>
